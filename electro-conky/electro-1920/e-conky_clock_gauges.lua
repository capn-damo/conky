--[[ e-conky_clock_gauges.lua by <damo.linux@gmail.com>, to be run from electro-1920.conkyrc

    The gauges are based on Conky Orange 4CPU
    <http://gnome-look.org/content/show.php/Conky+Orange+4+CPU?content=144319>
    
    In the "-- DISKS rings" section, set the "arg='/'" value to the directory mounts to be displayed.
--]]
require 'cairo'
...
gauge = {
{
    ...
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.25,
    graph_fg_colour=0x6A9BCB,      graph_fg_alpha=0.9,
...
-- DISKS rings
-- Set "arg=' '" to the directory mount to be displayed.
{
...
-- Adjust "max_value" and "graph_start_angle" for the sector to be displayed
    ...
    graph_unit_angle=2.7,          graph_unit_thickness=2.7,
    graph_bg_colour=0xffffff,      graph_bg_alpha=0.25,
    graph_fg_colour=0x5AC352,      graph_fg_alpha=0.9,
    hand_fg_colour=0x6A9BCB,       hand_fg_alpha=0.0,
    txt_radius=12,
    txt_weight=0,                  txt_size=9.0,
    txt_fg_colour=0xCE7646,        txt_fg_alpha=0,
